        ...
        $.ajax({
          ...
          success: function () {
            if ($form.is("[success-msg]")) {
              $form.append(
                "<div id='form-alert'><div class='alert alert-success'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button><strong>" +
          ...
          error: function () {
            if ($("#form-alert").length == 0) {
              $form.append(
                "<div id='form-alert'><div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button><strong>" +
                  $form.attr("fail-msg") +
                  "</strong></div></div>"
              );
            }
